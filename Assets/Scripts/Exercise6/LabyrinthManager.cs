...
public class LabyrinthManager : MonoBehaviour
{
    ...
    public void SetStart()
    {
        ...
        {
            selectedNode.labyrinthCubes.color = Color.blue;
    ...
    public void SetEnd()
    {
        if (selectedNode != null)
        {
            selectedNode.labyrinthCubes.color = Color.red;
            selectedNode.isWall = false;
    ...
    public void SetFloor()
    {
        if (selectedNode != null)
        {
            selectedNode.labyrinthCubes.color = Color.white;
            selectedNode.isWall = false;
        }
    ...
    public void SetWall()
    {
        if (selectedNode != null)
        {
            selectedNode.labyrinthCubes.color = Color.black;
    ...
    private bool CheckPathExists(LabyrinthNode startNode, LabyrinthNode endNode)
    {
        ...
        while (queue.Count > 0)
        {
            ...
            foreach (LabyrinthNode neighbor in GetValidNeighbors(currentNode))
            {
